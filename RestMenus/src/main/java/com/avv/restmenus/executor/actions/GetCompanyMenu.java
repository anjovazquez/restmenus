...
public class GetCompanyMenu extends AbstractOperationConnectorAction {

	public GetCompanyMenu() {
	}

	@Override
	public EntityResult execute(ConnectionBean connection) throws Exception {
		return connection.query(new Hashtable(), new Vector(), "ECompanyMenu");
	}
